...
// The Z2 axis, if any, should be the next open extruder port
...
#if MOTHERBOARD == BOARD_GT2560_REV_A_PLUS
  #define ELECTRONICS "MKS Base"
  #define KNOWN_BOARD
  #ifndef __AVR_ATmega2560__
    #error Oops!  Make sure you have 'Arduino Mega 2560' selected from the 'Tools -> Boards' menu.
  ...
  // no pins for microstepping on GT2560 - must be disabled because some map to pins GT2560 uses for thermistors.
 // #define X_MS1_PIN 40
 // #define X_MS2_PIN 41
 // #define Y_MS1_PIN 69
 // #define Y_MS2_PIN 39
 ...
 // #define E0_MS2_PIN 66
  ...
  #define BTN_EN1 42 // Swap with BTN_EN2 in case doesn't work ??
  #define BTN_EN2 40 //
  #define BTN_ENC 19 //
